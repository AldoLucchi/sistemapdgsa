<x-default-layout>
    ...
    <div class="card">
        ...
        <div class="card-body py-4">
            ...
            <form id="edit_Accesosdirectos69_form" name="edit_Accesosdirectos69_form" class="form" action="{{ route('admin.accesoDirecto.update', $Accesosdirectos69) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
