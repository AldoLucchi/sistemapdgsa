...
<div class="card">
    ...
    <div class="card-body py-4">
        <!--begin::Table-->
        <form id="add_BitacorasAcciones70_form" name="add_BitacorasAcciones70_form" class="form" action="{{ route('admin.bitacoraAccion.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
