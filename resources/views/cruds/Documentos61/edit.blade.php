<x-default-layout>
    ...
    <div class="card">
        ...
        <div class="card-body py-4">
            ...
            <form id="edit_Documentos61_form" name="edit_Documentos61_form" class="form" action="{{ route('admin.documento.update', $Documentos61) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
