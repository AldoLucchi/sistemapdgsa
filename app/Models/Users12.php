...
class Users12 extends Model
{
	...
	protected $fillable = [
        'id','name','email','profile_photo_path','email_verified_at','password','avatar','idcliente','nombre','apellido','cedula','movilpersonal','movilempresa','foto','firma','observaciones','idestatus','insertar','editar','listar','eliminar','imprimir','admin','idrol','codigocrm',
    ];	
