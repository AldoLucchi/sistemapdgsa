...
class EditCrudModal extends Component
{
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.crud.edit-crud-modal', compact('cruds_availables', 'cruds_filtered', 'cruds_filtered_columns'));
    }

    public function submit(Request $request)
    {
        Log::info('EditCrudModal - submit');
        Log::info($request);
    ...
    public function updateCrud($id)
    {
        ...
        Log::info($crud );
            ...
            $this->crud_id = $crud->id;
            
            $this->nombre = $crud->nombre;
            
            $this->estatus = $crud->estatus;
            
            $this->alias_opcion = $crud->alias_opcion;
            $this->nombre_componente = $crud->nombre_componente;
